...
public class SwerveModule {
  ...
  private SparkMaxAbsoluteEncoder analogEncoder =
      steerController.getAbsoluteEncoder(SparkMaxAbsoluteEncoder.Type.kDutyCycle);
  ...
  public SwerveModuleState getState() {
    return new SwerveModuleState(
        powerController.getEncoder().getVelocity() * Constants.Swerve.RPM_TO_MS,
  ...
  public void setState(SwerveModuleState state) {
    ...
    powerController
        .getPIDController()
        .setReference(
            state.speedMetersPerSecond / Constants.Swerve.RPM_TO_MS, ControlType.kVelocity);
    steerController
        .getPIDController()
